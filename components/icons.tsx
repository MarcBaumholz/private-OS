...
export const DropletIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 14.25c0-3.314 3.134-6 7-6s7 2.686 7 6c0 3.314-2.239 6.707-7 11.25C10.239 20.957 7.5 17.564 7.5 14.25z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.5 14.25a3.5 3.5 0 11-7 0 3.5 3.5 0 017 0z" />
    </svg>
);
